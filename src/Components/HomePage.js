...
export default function HomePage() {
    ...
    const navDem = useRef()
    const ticketMod = useRef()
    let myIndex=useRef(0)
    function myFunction(e){
        const x = navDem.current
    ...
    function carousel() {
        ...
        myIndex.current=myIndex.current+1;
        if (myIndex.current > x.length) {myIndex.current = 1}    
        x[myIndex.current-1].style.display = "block";  
        setTimeout(carousel, 4000);    
      }

    function handleDisplay(e){
        if(e.target.value){
            ticketMod.current.style.display="block"
        }
        else{
            ticketMod.current.style.display="none"
        }
    }
    useEffect(() => {
        carousel()
  ...
  <div className="w3-top">
    <div className="w3-bar w3-black w3-card">
      <a className="w3-bar-item w3-button w3-padding-large w3-hide-medium w3-hide-large w3-right" href="#" onClick={myFunction} title="Toggle Navigation Menu"><i className="fa fa-bars" /></a>
      ...
      <div className="w3-dropdown-hover w3-hide-small">
        <button className="w3-padding-large w3-button" title="More">MORE <i className="fa fa-caret-down" /></button>     
      ...
      <a href="#" className="w3-padding-large w3-hover-red w3-hide-small w3-right"><i className="fa fa-search" /></a>
    </div>
  </div>
  {/* Navbar on small screens (remove the onclick attribute if you want the navbar to always show on top of the content when clicking on the links) */}
  <div id="navDemo" ref={navDem} className="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style={{marginTop: 46}}>
  ...
  <div className="w3-content" style={{maxWidth: 2000, marginTop: 46}}>
    ...
    <div className="w3-black" id="tour">
      <div className="w3-container w3-content w3-padding-64" style={{maxWidth: 800}}>
        ...
        <div className="w3-row-padding w3-padding-32" style={{margin: '0 -16px'}}>
          <div className="w3-third w3-margin-bottom">
            ...
            <div className="w3-container w3-white">
              ...
              <button className="w3-button w3-black w3-margin-bottom" value="true" onClick={handleDisplay}>Buy Tickets</button>
            </div>
          </div>
          <div className="w3-third w3-margin-bottom">
    ...
    {/* Ticket Modal */}
    <div id="ticketModal" ref={ticketMod} className="w3-modal" style={{}}>
      <div className="w3-modal-content w3-animate-top w3-card-4">
        <header className="w3-container w3-teal w3-center w3-padding-32"> 
          <span value="false" onClick={handleDisplay} className="w3-button w3-teal w3-xlarge w3-display-topright">×</span>
          <h2 className="w3-wide"><i className="fa fa-suitcase w3-margin-right" />Tickets</h2>
        </header>
        <div className="w3-container">
          <p><label><i className="fa fa-shopping-cart" /> Tickets, $15 per person</label></p>
          <input className="w3-input w3-border" type="text" placeholder="How many?" />
          <p><label><i className="fa fa-user" /> Send To</label></p>
          <input className="w3-input w3-border" type="text" placeholder="Enter email" />
          <button className="w3-button w3-block w3-teal w3-padding-16 w3-section w3-right">PAY <i className="fa fa-check" /></button>
          <button className="w3-button w3-red w3-section" value="false" onClick={handleDisplay}>Close <i className="fa fa-remove" /></button>
    ...
    <div className="w3-container w3-content w3-padding-64" style={{maxWidth: 800}} id="contact">
      ...
      <div className="w3-row w3-padding-32">
        <div className="w3-col m6 w3-large w3-margin-bottom">
          <i className="fa fa-map-marker" style={{width: 30}} /> Chicago, US<br />
          <i className="fa fa-phone" style={{width: 30}} /> Phone: +00 151515<br />
          <i className="fa fa-envelope" style={{width: 30}}> </i> Email: mail@mail.com<br />
        </div>
